...
abstract class $ProfileCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String? firstName, String? lastName, List<MyFishTank>? myFishTanks});
}
...
class _$ProfileImpl implements _Profile {
  const _$ProfileImpl(
      {this.firstName, this.lastName, final List<MyFishTank>? myFishTanks})
  ...
  @override
  String toString() {
    return 'Profile(firstName: $firstName, lastName: $lastName, myFishTanks: $myFishTanks)';
  }
...
abstract class _Profile implements Profile {
  const factory _Profile(
      {final String? firstName,
      final String? lastName,
      final List<MyFishTank>? myFishTanks}) = _$ProfileImpl;
